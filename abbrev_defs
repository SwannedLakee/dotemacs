...
(define-abbrev-table 'xah-elisp-mode-abbrev-table
  '(
    ...
    ("add-hook" "(add-hook 'HOOK▮ 'FUNCTION)" xah-elisp--ahf :count 2)
    ...
    ("ah" "add-hook" xah-elisp--ahf :count 2)
...
3
    ...
    ("delete-region" "(delete-region p1▮ p2)" xah-elisp--ahf :count 1)
    ...
    ("dr" "delete-region" xah-elisp--ahf :count 1)
    ...
    ("fc" "forward-char" xah-elisp--ahf :count 2)
    ...
    ("forward-char" "(forward-char ▮)" xah-elisp--ahf :count 2)
  ...
  (progn )
    ...
    ("l" "let" xah-elisp--ahf :count 1)
    ("la" "looking-at" xah-elisp--ahf :count 0)
    ("lam" "lambda" xah-elisp--ahf :count 0)
    ("lambda" "(lambda (x▮) BODY)" xah-elisp--ahf :count 1)
 ...
 x
    ...
    ("m" "message" xah-elisp--ahf :count 2)
...
(lambda (x▮) BODY)
 SEQUENCE)" xah-elisp--ahf :count 0)
    ...
    ("message" "(message \"%s▮\" ARGS)" xah-elisp--ahf :count 1)
...
▮)" xah-elisp--ahf :count 0)
    ...
    ("region-beginning" "(region-beginning)" xah-elisp--ahf :count 1)
    ("region-end" "(region-end)" xah-elisp--ahf :count 1)
 ...
 (narrow-to-region p1▮ p2) 
    ...
    ("sb" "search-backward" xah-elisp--ahf :count 1)
    ...
    ("search-backward" "(search-backward \"▮\" &optional BOUND NOERROR COUNT)" xah-elisp--ahf :count 1)
    ("search-backward-regexp" "(re-search-backward \"▮\" &optional BOUND NOERROR COUNT)" xah-elisp--ahf :count 0)
    ("search-forward" "(search-forward \"▮\" &optional BOUND NOERROR COUNT)" xah-elisp--ahf :count 1)
    ...
    ("sf" "search-forward" xah-elisp--ahf :count 1)
    ...
    ("split-string" "(split-string ▮ &optional SEPARATORS OMIT-NULLS)" xah-elisp--ahf :count 4)
    ("sqa" "shell-quote-argument" xah-elisp--ahf :count 0)
    ("sr" "save-restriction" xah-elisp--ahf :count 0)
    ("ss" "split-string" xah-elisp--ahf :count 1)
    ...
    ("ste" "string-equal" xah-elisp--ahf :count 1)
